FROM bash:5
RUN apk --no-cache add curl gettext ca-certificates openssl \
    && wget https://github.com/Yelp/dumb-init/releases/download/v1.2.2/dumb-init_1.2.2_x86_64 -O /usr/local/bin/dumb-init \
